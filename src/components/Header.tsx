    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <a href="#" className="text-xl font-medium">
          <span className="sr-only">Alex Morgan</span>
        ...
        <nav className={cn(
          "fixed md:relative top-0 right-0 h-screen md:h-auto w-64 md:w-auto bg-white md:bg-transparent transform transition-transform duration-300 ease-in-out md:translate-x-0 z-50",

      ...
      >
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <div className="space-y-4">
            ...
            <h2 className="text-xl md:text-2xl text-foreground/80 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
              {personalInfo.title}
            </h2>
            
            <p className="max-w-2xl mx-auto text-lg text-foreground/70 leading-relaxed text-balance animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
              {personalInfo.bio}
            </p>
          </div>
          
          <div className="flex items-center justify-center gap-6 pt-4 animate-fade-in-up" style={{ animationDelay: '0.7s' }}>
            <a 
              href="#about"
